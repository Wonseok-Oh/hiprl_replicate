...
(:objects
    ...
    box0 box2 box1 - receptacle
    ball0 - obj
    ball_type - otype
    down left right up - direction
)
(:init
    (at_location robot f2-4f)

    (receptacle_at_location box0 f2-3f)
    (receptacle_at_location box2 f6-7f)
    (receptacle_at_location box1 f6-5f)
...
(:goal (and
    (object_at_location ball0 f8-5f)
))
)
