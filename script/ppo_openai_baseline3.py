...
#env = make_vec_env('MiniGrid-HiPRLGrid-v0', n_envs=8, start_index = 16)
env = gym.make('MiniGrid-HiPRLGrid-v0', process_num = 0)
#check_env(env)
#env = Monitor(env)
#env = DummyVecEnv([lambda: env])
#eval_callback = EvalCallback(env, best_model_save_path='./logs_hiprl_new/',
#                             log_path='./logs_hiprl_new/', eval_freq=100, n_eval_episodes=100,
...
#model.learn(total_timesteps=100000, callback=eval_callback, tb_log_name="hip_rl_new")
#model.learn(total_timesteps=50000, tb_log_name="test_stable_baseline3")

#model.save("ppo2_HiPRLGrid_new")

#del model # remove to demonstrate saving and loading

model = PPO.load("./logs_hiprl_new/best_model")
...
print("HiP-RL's 100 Evaluation Results:")
