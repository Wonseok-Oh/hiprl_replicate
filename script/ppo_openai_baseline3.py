...
#env = make_vec_env('MiniGrid-HiPRLGrid-v0', n_envs=8, start_index = 0)
env = gym.make('MiniGrid-HiPRLGrid-v0')
#check_env(env)
#env = Monitor(env)
#env = DummyVecEnv([lambda: env])
eval_callback = EvalCallback(env, best_model_save_path='./logs_hiprl/',
                             log_path='./logs_hiprl/', eval_freq=100, n_eval_episodes=100,
...
#model.learn(total_timesteps=100000, callback=eval_callback, tb_log_name="test_stable_baseline3")
