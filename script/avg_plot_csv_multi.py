...
df = pd.read_csv('~/Downloads/multi_data/iehiprl_sr.csv')
df2 = pd.read_csv('~/Downloads/multi_data/hiprl_sr.csv')
#df3 = pd.read_csv('~/Downloads/multi_data/test_stable_baseline3_mine_3_sr.csv')

df4 = pd.read_csv('~/Downloads/multi_data/iehiprl_r.csv')
df5 = pd.read_csv('~/Downloads/multi_data/hiprl_r.csv')
#df6 = pd.read_csv('~/Downloads/test_stable_baseline3_mine_3_mr.csv')

df7 = pd.read_csv('~/Downloads/multi_data/iehiprl_makespan.csv')
df8 = pd.read_csv('~/Downloads/multi_data/hiprl_makespan.csv')
...
ax1.plot(df2['Step'], df2['EWM'], label = "HiP-RL", color='red')
...
ax2.plot(df5['Step'], df5['EWM'], color='red')
ax2.plot(df4['Step'], df4['EWM'], color='blue')
...
ax3.plot(df8['Step'], df8['EWM'], color='red')
ax3.plot(df7['Step'], df7['EWM'], color='blue')
